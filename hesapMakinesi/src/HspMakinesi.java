 ...
 * @author zeynepsevgi
 */
public class HspMakinesi extends javax.swing.JFrame {
    
    double num,ans;
    int hesap;
    
    public void hesap_islemleri(){
        switch(hesap){
            case 1:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HspMakinesi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HspMakinesi().setVisible(true);
            }
        });
    }
